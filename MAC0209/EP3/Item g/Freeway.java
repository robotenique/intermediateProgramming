...
public class Freeway implements Drawable {
	...
	public void step() {
		...
		for (int i = 0; i < this.numberOfCars; i++) {
			...
			if (this.v[i] < this.maximumVelocity) {
			...
			if (this.v[i] >= d) {
				...
				if (this.lanes > 1 && this.lane[i]+1 < this.lanes && this.v[i] < this.maximumVelocity
