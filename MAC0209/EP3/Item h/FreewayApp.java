...
public class FreewayApp extends AbstractSimulation {
	...
	public void initialize() {
		...
		this.freeway.maximumVelocityCar = this.control.getInt("Maximum velocity for cars");
		this.freeway.maximumVelocityTruck = this.control.getInt("Maximum Velocity for trucks");
...
//	}
	...
	public void reset() {
		...
		this.control.setValue("Number of lanes", 3);
		this.control.setValue("Slow down probability", 0.5);
		this.control.setValue("Maximum velocity for cars", 3);
		this.control.setValue("Maximum Velocity for trucks", 2);
