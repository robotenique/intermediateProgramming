...
/******************************************************************************
 *  Compilation:  javac MinhaRBT.java
 *  Execution:    java MinhaRBT < input.txt
...
public class MinhaRBT<Key extends Comparable<Key>, Value> {
    ...
    private Value getCounter(Node x, Key key){
        while (x != null) {
    ...
    public double averageSearchMiss() {
        double steps = 0;
        steps = putCounter(root, steps);
        return steps/(size() + 1); // Maybe change it
    }
    private double putCounter(Node x, double steps) {
        if(x == null) return 1 + steps;
        return putCounter(x.left, steps + 1) + putCounter(x.right, steps + 1);
    }
   /***************************************************************************
    *  Node helper methods.
    ***************************************************************************/
    ...
    ***************************************************************************/
    ...
    private Node put(Node h, Key key, Value val, int depth) {
        if (h == null){
            if (depth > eagerHeight)
                eagerHeight = depth;
