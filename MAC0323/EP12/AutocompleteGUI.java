 ...
 * da edição 2017.
 * 
 * Esta é uma adaptação que substitui as classse Term e BinarySearchDeluxe originais 
 * do assignment por uma adaptação da classe TST.
 * 
 * As linhas adaptadas para MAC0323 contém um comentário com o rótulo "MAC0323"
 * (hmm, quase todas...)
 */

// import edu.princeton.cs.algs4.StdOut; // MAC0323 Usado para achar erros na adaptação
...
public class AutocompleteGUI extends JFrame {
    ...
    private class AutocompletePanel extends JPanel {
        ...
        public AutocompletePanel(String filename) {
            ...
            // auto passou a ser uma tabela de símbolos da classe MeuTST
        ...
        public void getSuggestions(String text) {
            ...
            if (text.equals("")) {
                ...
                // TAREFA. se você ainda não fez sua tarefa, descomente a linha anterior e comente a
                //         proxima.
                ...
                // StdOut.println("cheguei até aqui: " + text + "  " + textLen); MAC0323
                ...
                for (String query: allResults) { // MAC0323
                    allResultsSize += 1;         // MAC0323 Não sei pegar o size de Iterable
